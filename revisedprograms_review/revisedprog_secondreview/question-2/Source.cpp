...
int main()
{
	...
	for (int j = 0; j < length_string1; j++) {
		...
		if (string_input[j] == '!' || string_input[j] == '@' || string_input[j] == '#' || string_input[j] == '$' || string_input[j] == '%' || string_input[j] == '^' || string_input[j] == '&' || string_input[j] == '*' || string_input[j] == '(' || string_input[j] == ')') {
